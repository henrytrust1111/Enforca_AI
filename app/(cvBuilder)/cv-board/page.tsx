...
const CvBoardPage: React.FC = () => {
  // Define the type for activeFeedbackCategory
  const [activeFeedbackCategory, setActiveFeedbackCategory] = useState<
    "Impact" | "Brevity" | "Style" | "Sections" | "Skills"
  >("Impact");
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        {/* Fix Modal */}
        {showFixModal && <FixModal closeModal={() => setShowFixModal(false)} />}
      </div>
    </>
  );
};
