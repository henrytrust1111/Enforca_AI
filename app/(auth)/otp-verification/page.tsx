...
//       <div className="flex flex-col h-screen sm:h-full items-center sm:justify-center sm:p-6 md:bg-white">
//         <div className="relativew-full max-w-sm bg-[#F4F8FD] sm:bg-transparent">
//           <p className="font-medium absolute top-20 hidden sm:block py-4 sm:py-0 sm:right-12 cursor-pointer hover:underline hover:underline-offset-2 hover:text-primary">
//             Go Back
//           </p>
//           <p className="font-medium absolute top-20 left-9 sm:hidden py-4 sm:py-0 sm:right-12 cursor-pointer hover:underline hover:underline-offset-2 hover:text-primary">
//             Go Back
//           </p>
//           <div className="sm:text-center pb-16 flex flex-col sm:items-center text-black-100 gap-12 p-6 sm:p-0 mb-12">
//             {/* Logo */}
