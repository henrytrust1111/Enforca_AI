    ...
    return (
        <>
            ...
            <div className="py-16 pl-4 md:px-20">
                <p className='text-center text-sm font-normal font-sharpsans'>We are trusted by these brands</p>
                <div className="mt-3">
            ...
            <div className="w-full flex flex-col items-center justify-center py-16 px-4 md:px-20 gap-4 font-sharpsans">
                <p className='text-2xl md:text-4xl font-bold text-center max-w-2xl font-sharpsans'><span className="text-[#111D63]">Land your dream job faster</span> with personalized support every step of the way.</p>
                <p className='text-[#788087] max-w-3xl text-center'>Never face the job search alone. Our app connects you with a dedicated mentor, personalizes your CV for success, and equips you with interview skills through realistic simulations and expert feedback. Land your dream job faster with all-in-one support.</p>
            </div>
        </>
